...
urlpatterns = [
    ...
    path('printing/<int:pk>/complete/', views.printing_order_complete, name='printing_order_complete'),
    ...
    path("printing/<int:pk>/movements/pdf/", views.printing_order_movements_pdf,name="printing_order_movements_pdf"),
